...
//                     <div className='w-8/12 h-[12px] rounded-2xl bg-[#222222] shadow-inner shadow-[#00000040]' />
...
//                 <>
//                     <Icon size={80} className='text-white' />
//                     <div className='w-8/12 h-[12px] rounded-2xl bg-[#222222] shadow-inner shadow-[#00000040] progress' />
//                     <div className='h-[108px]'>
...
//                 <>
//                     <Icon size={80} className='text-white' />
//                     <div className='w-8/12 h-[12px] rounded-2xl success shadow-inner shadow-[#00000040]' />
...
//                 <>
//                     <Icon size={80} className='text-white' />
//                     <div className='w-8/12 h-[12px] rounded-2xl fail shadow-inner shadow-[#00000040]' />
