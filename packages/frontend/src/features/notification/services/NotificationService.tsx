...
class NotificationService {
    async fetchNotifications(): Promise<Notification[]> {
        ...
        const notifications = [
            ...
            { id: 3, type: 'POST_FAILED', time: '2 hours ago', isRead: true },
            { id: 4, type: 'COMMENT_SUCCEEDED', time: '3 hours ago', isRead: false },
            { id: 5, type: 'COMMENT_FAILED', time: '4 hours ago', isRead: true },
            { id: 6, type: 'UPVOTE_SUCCEEDED', time: '5 hours ago', isRead: false },
            { id: 7, type: 'UPVOTE_FAILED', time: '6 hours ago', isRead: true },
            { id: 8, type: 'DOWNVOTE_SUCCEEDED', time: '7 hours ago', isRead: false },
            { id: 9, type: 'DOWNVOTE_FAILED', time: '8 hours ago', isRead: true },
            { id: 10, type: 'REPORT_SUCCEEDED', time: '9 hours ago', isRead: false },
            { id: 11, type: 'REPORT_FAILED', time: '10 hours ago', isRead: true },
            { id: 12, type: 'REPORT_PASSED', time: '11 hours ago', isRead: false },
            { id: 13, type: 'REPORT_REJECTED', time: '12 hours ago', isRead: true },
            { id: 14, type: 'BE_REPORTED', time: '13 hours ago', isRead: false },
            { id: 15, type: 'ADJUDICATE_SUCCEEDED', time: '14 hours ago', isRead: true },
            { id: 16, type: 'ADJUDICATE_FAILED', time: '15 hours ago', isRead: false },
            { id: 17, type: 'ADJUDICATE_RESULT_PASSED', time: '16 hours ago', isRead: true },
            { id: 18, type: 'ADJUDICATE_RESULT_REJECTED', time: '17 hours ago', isRead: false },
            { id: 19, type: 'NEW_REPORT_ADJUDICATE', time: '18 hours ago', isRead: true },
