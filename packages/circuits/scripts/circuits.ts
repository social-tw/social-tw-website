...
export const circuitContents = {
    ...
    dailyClaimProof: `pragma circom 2.1.0; include "../circuits/dailyClaimProof.circom"; \n\ncomponent main { public [ daily_nullifier, daily_epoch ] } = DailyClaimProof(${STATE_TREE_DEPTH}, ${NUM_EPOCH_KEY_NONCE_PER_EPOCH}, ${SUM_FIELD_COUNT}, ${FIELD_COUNT}, ${REPL_NONCE_BITS});`,
}
